...
_VIEWER_HEADERS = {"X-KTG-Actor": "catalog-test", "X-KTG-Roles": "source_file_viewer"}
...
async def test_source_file_categories_endpoint_returns_full_catalog() -> None:
    response = await _get_categories(_VIEWER_HEADERS)
...
@pytest.mark.asyncio
async def test_source_file_categories_endpoint_requires_admin_proxy_identity() -> None:
