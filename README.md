...
| 표면 | 공식 host 포트 | 비고 |
|------|----------------|------|
| PostgreSQL + PostGIS | `15434` | Docker 내부 포트는 `5432`, DSN은 `localhost:15434` |
| FastAPI 백엔드 | `8888` | Swagger UI: `http://localhost:8888/v1/docs` |
| `kraddr-geo-ui` | `13088` | Docker/브라우저/e2e 기준 URL. Next 내부 포트 `3000`은 외부 공식 포트가 아님 |

상세 실행 예시는 [`docs/ports.md`](docs/ports.md)를 참조합니다.
