...
- 기준 DB: Docker PostGIS `kraddr_geo`, `mv_geocode_target=6,416,637`
...
- 실제 DB semantic parity: `KRADDR_GEO_TEST_PG_DSN=... pytest tests/integration/test_optional_real_postgres_text_search.py -q`
