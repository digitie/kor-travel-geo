...
기본 live 실행은 `optional-source`, `future-followup` 태그를 제외한다. T-171 이후 `T140-GEO-ROAD-FUZZY-001`은 기본 live에 포함되는 ranking case이며, 도로명 오타 입력에서도 같은 본번·부번 후보가 1순위인지 확인한다. epost 사서함/다량배달처와 아직 기대 field를 좁히지 않은 boundary seed는 fixture에는 남기되, 후속 task에서 OK 기준으로 승격한다.
...
- corpus SHA-256: `e8e6522f1fec49fc843137f46fdec5afc6ba65efd348842207ef7fec5246b7d1`
- cases: `23`
- selected: `23`
- ok: `23`
- errors: `0`
...
- T-172/T-165: confidence model과 normalization 작업에서 관련 case의 expected field를 더 좁힌다. T-171 fuzzy ranking case는 `ranking` 태그와 `numeric_gte` confidence 하한으로 승격됐다.
