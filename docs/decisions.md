...
8. **T-109(PR #131)는 ②의 설계 문서**이며, 구현은 T-200대(T-200~T-210)로 분할한다.
...
- (open) T-106 호환 수준(키 호환 vs wire 100%) RFC 확정 — ADR-038 보정 여부 포함.
