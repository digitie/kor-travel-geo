...
`.env*`, `.claude/`, `.codegraph/`는 ignore 대상이어야 한다. API 로컬 포트는 `12201`이므로 `KTG_API_INTERNAL_URL` 예시는 `http://localhost:12201`로 맞춘다.
...
|------|----------------|-----------|------|
| FastAPI 백엔드 | `12201` | `12201` | `uvicorn kortravelgeo.api.app:app --host 127.0.0.1 --port 12201` |
| `kor-travel-geo-ui` | `12205` | `12205` | Docker는 `-p 12205:12205`, local dev는 `npm run dev -- --port 12205` |
