...
| `도로명주소 출입구 정보/` | 별도 출입구 정보 | 미지원 | T-030에서 direct `bd_mgt_sn + EPSG:5179` 텍스트로 확인. T-039 후보 |
...
| T-039 `도로명주소 출입구 정보` direct entrance loader | direct `bd_mgt_sn + EPSG:5179` 텍스트 보완 여부 결정 |
