...
| `daily/*.zip` | 일변동 ZIP 20260401~20260506 | 부분 지원 | T-028 이후 `TH_SGCO_RNADR_MST.TXT`는 `tl_juso_text` 증분 적용 가능. `TH_SGCO_RNADR_LNBR.TXT`는 manifest에 행 수만 기록하고 T-029에서 1:N 지번 관계를 결정 |
