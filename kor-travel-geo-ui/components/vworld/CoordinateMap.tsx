...
const OVERLAY_SOURCE_ID = "kor-travel-geo-overlay";
const OVERLAY_FILL_LAYER_ID = "kor-travel-geo-overlay-fill";
const OVERLAY_LINE_LAYER_ID = "kor-travel-geo-overlay-line";
const OVERLAY_POINT_LAYER_ID = "kor-travel-geo-overlay-point";
  ...
  return (
    <div className="vworld-map-shell">
      ...
      >
        ...
        {point ? <Marker color="#2563eb" lngLat={[point.x, point.y]} /> : null}
      </VWorldMap>
