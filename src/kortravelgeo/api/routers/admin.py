...
from kortravelgeo.infra.admin_repo import AdminRepository, canonical_audit_outcome
...
async def validate_source_file_group(
    ...
    await client.record_audit_event(
        ...
        actor_type="ui",
        actor_id=ctx.actor,
        outcome=canonical_audit_outcome(result.validation_state),
...
async def soft_delete_source_file_group(
    ...
    await client.record_audit_event(
        ...
        actor_type="ui",
        actor_id=ctx.actor,
        outcome=canonical_audit_outcome(result.state),
...
async def resolve_source_reconcile_item(
    ...
    await client.record_audit_event(
        ...
        actor_type="ui",
        actor_id=ctx.actor,
        outcome=canonical_audit_outcome(result.outcome),
...
async def create_source_match_set(
    ...
    await client.record_audit_event(
        ...
        actor_type="ui",
        actor_id=ctx.actor,
        outcome=canonical_audit_outcome(result.match_set.state),
...
async def rollback_serving_release(
    ...
    await client.record_audit_event(
        ...
        actor_type="ui",
        actor_id=ctx.actor,
        outcome=canonical_audit_outcome(result.mode),
        payload={
            "mode": result.mode,
